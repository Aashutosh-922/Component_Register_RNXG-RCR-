...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mail = findViewById(R.id.editTextEmailAddress2);
        confirm = findViewById(R.id.ediTextNumberPassword2);
                ...
                if (task.isSuccessful()) {
                    ...
                    if (user != null) {
                        user.sendEmailVerification().addOnSuccessListener(unused -> Toast.makeText(SignupActivity.this, "Email verification has been sent:", Toast.LENGTH_SHORT).show()).
                                addOnFailureListener(e -> Toast.makeText(SignupActivity.this, "Email verification not sent.", Toast.LENGTH_SHORT).show());
                    }

...
public class component_data<ActivityUpdateDataBinding> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        KK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Components").child(text).setValue(number);
                databaseReference2.child("Working").child(text).setValue(number2);
                databaseReference3.child("Non-Working").child(text).setValue(number3);
            }
        });
